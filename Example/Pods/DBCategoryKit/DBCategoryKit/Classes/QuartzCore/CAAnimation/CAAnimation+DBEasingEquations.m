//
//  CAAnimation+DBEasingEquations.m
//  DBCategoryKit
//
...
@implementation CAAnimation (DBEasingEquations)
...
+ (void)db_addAnimationToLayer:(CALayer *)layer
                ...
                easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self db_transformAnimationWithDuration:duration
...
+ (void)db_addAnimationToLayer:(CALayer *)layer
                ...
                easingFunction:(CAAnimationEasingFunction)easingFunction
{
    [self db_addAnimationToLayer:layer
                     withKeyPath:keyPath
                        duration:duration
...
+ (void)db_addAnimationToLayer:(CALayer *)layer
                ...
                easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self db_animationWithKeyPath:keyPath
                                                  duration:duration
                                                      from:startValue
                                                        to:endValue
                                            easingFunction:easingFunction];
