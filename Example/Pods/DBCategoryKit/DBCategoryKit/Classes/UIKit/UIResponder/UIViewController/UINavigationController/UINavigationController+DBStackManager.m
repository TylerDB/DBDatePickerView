//
//  UINavigationController+DBStackManager.m
...
@implementation UINavigationController (DBStackManager)
...
{
    return [self popToViewController:[self db_findViewController:className] animated:YES];
}
