...
@interface UIImage (DBAlphaPrivateMethods)

- (CGImageRef)db_newBorderMask:(NSUInteger)borderSize size:(CGSize)size;

@end

@implementation UIImage (DBAlpha)
...
- (UIImage *)db_transparentBorderImage:(NSUInteger)borderSize {
    ...
    CGImageRef maskImageRef = [self db_newBorderMask:borderSize size:newRect.size];
